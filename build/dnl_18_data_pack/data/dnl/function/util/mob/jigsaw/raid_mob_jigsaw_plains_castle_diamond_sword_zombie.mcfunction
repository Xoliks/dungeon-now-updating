...
item replace entity @p weapon.mainhand with jigsaw[block_entity_data={id:"minecraft:jigsaw",joint:"aligned",name:"minecraft:empty",pool:"dnl:plains_castle/raid_mob/diamond_sword_zombie",final_state:"minecraft:air",target:"dnl:mob_connector"}]
kill @s
