...
item replace entity @p weapon.mainhand with jigsaw[block_entity_data={id:"minecraft:jigsaw",joint:"aligned",name:"minecraft:empty",pool:"dnl:plains_pillager_camp/raid_mob/evoker",final_state:"minecraft:air",target:"dnl:mob_connector"}]
kill @s
