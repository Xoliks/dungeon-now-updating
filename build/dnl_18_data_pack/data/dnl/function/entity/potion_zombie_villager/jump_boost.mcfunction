...
execute if score @s dnl.timer matches 1 run item replace entity @s weapon.mainhand with potion[potion_contents="minecraft:strong_leaping"]
execute if score @s dnl.timer matches 30 run effect give @s minecraft:jump_boost 90 1
execute if score @s dnl.timer matches 30 run tag @s remove dnl.potion_zombie_villager.jump_boost
