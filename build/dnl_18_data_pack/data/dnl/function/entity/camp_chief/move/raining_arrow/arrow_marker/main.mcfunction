...
execute if score @s dnl.timer matches 1..40 run particle dust_color_transition{from_color:[1.0,0.051,0.051],scale:1,to_color:[0.0,0.0,0.0]} ~ ~ ~ 0.1 0.1 0.1 0.01 5 force
