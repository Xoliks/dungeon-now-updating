...
execute as @e[type=marker, tag=dnl.core, tag=dnl.nautilus_guardian] if score @s dnl.eid = #dnl.death_entity_id dnl.eid at @s run function dnl:entity/nautilus_guardian/core/death
