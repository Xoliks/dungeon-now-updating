...
execute if score @s dnl.mainhand.timer matches 1 run attribute @s minecraft:knockback_resistance base set 1
execute if score @s dnl.mainhand.timer matches 1..40 run particle block{block_state:{Name:"dirt"}} ~ ~ ~ 0.2 0 0.2 0.1 10 normal
execute if score @s dnl.mainhand.timer matches 40 run effect give @s minecraft:speed 3 2 true
execute if score @s dnl.mainhand.timer matches 40 run attribute @s minecraft:knockback_resistance base set 0
