...
execute store success score #dnl.monolith.ingredient_6_nbt dnl.boolean run data modify storage dnl:monolith/container Item.components."minecraft:potion_contents" set from storage dnl:monolith/ingredients Ingredients[6].nbt
