...
execute if score #dnl.monolith.ingredient_2 dnl.boolean matches 0 if score #dnl.monolith.ingredient_2_nbt dnl.boolean matches 0 run function dnl:monolith/ancient_sword/ingredient_2/matched
